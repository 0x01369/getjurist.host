...
$config = [
    ...
    'aliases' => [
        ...
        '@root'   => '/var/www/www-root/data/www/myslook.com/',
        '@web' => 'http://myslook.com/'
    ],
    'components' => [
        'request' => [
        ...
        'db' => [
            ...
            'dsn' => 'mysql:host=localhost;dbname=myslook',
            'username' => 'myslook',
            'password' => '3X1g9I7z',
            'charset' => 'utf8mb4',
        ],
        'dbChat' => [
            'class' => 'yii\db\Connection',
            'dsn' => 'mysql:host=localhost;dbname=myslook_ejabberd',
            'username' => 'myslook_ejabberd',
            'password' => 'C8k9V6z8',
            'charset' => 'utf8mb4',
        ],
        'urlManager' => [
